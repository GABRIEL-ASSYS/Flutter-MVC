class GoogleBook {
  ...
  validateDescription(Map<String, dynamic> map) => map["volumeInfo"]["description"] == null ? "Sem descricao" : map["volumeInfo"]["description"];
  ...
  validateTitle(Map<String, dynamic> map) => map["volumeInfo"]["title"] == null ? "Título desconhecido" : title = map["volumeInfo"]["title"];
